...
const features: FeatureType[] = [
    {
        ...
        description:
            "Passionate about developing creative ideas and writing in different areas. I develop content aimed at social networks, ebooks, magazines, brochures, catalogs and websites.",
    },
    {
        iconInfo: {
            icon: "burger",
    ...
    },
    {
        ...
        title: "Mockups",
        description:
            "There is no better tool than the one that, in advance, allows us to understand what the final product will look like in a 100% realistic way! The mockups that I develop as business cards, merchandising objects, packaging, out doors among others, always go hand in hand with Adobe Photoshop.",
    },
    {
        iconInfo: {
            icon: "burger",
        ...
        title: "Logotypes",
        description:
            "The visual identity of a brand is the most important in a business. It is the creation of a logo, with or without text present, that allows a customer to create some kind of connection and remembrance to the brand. Who never, through a brand name or the visualization of its logo, associates it with something good or bad?",
    },
    {
        iconInfo: {
            icon: "burger",
